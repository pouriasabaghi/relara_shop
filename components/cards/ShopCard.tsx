...
export default function ShopCard({title,price,image,id,quantity}:ShopCard) {
      ...
      <div className="flex flex-1 flex-col justify-between">
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-md md:text-lg font-semibold text-gray-900">${price}</p>
          </div>

          {/* increment and decrement buttons */}
          <div className="flex items-center gap-2 md:gap-4 rounded-md border border-gray-300 bg-gray-100 px-2 py-1 ml-3">
            <button className="text-gray-600 transition hover:text-gray-900 text-sm md:text-base" onClick={removeFromCartHandler}>
              <FaMinus />
            </button>
            <span className="text-sm font-semibold text-gray-800">1</span>
            <button className="text-gray-600 transition hover:text-gray-900 text-sm md:text-base" onClick={addToCartHandler}>
              <FaPlus />
            </button>
          </div>
        </div>
